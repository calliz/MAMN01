...
public class ResourcesOverlay extends ItemizedOverlay {
	...
	public ResourcesOverlay(Drawable defaultMarker) {
		/*
		 * Calling boundCenterBottom() on defaultMarker makes the marker image
		 * connect at its Bottom center to the latitude and longitude of this
		 * Overlay Item
		 */
		...
		/*
		 * This call to populate is important. Although this does not appear in
		 * the MapView tutorial on Google's Android developer site, the mapview
		 * some times crashes without this call.
		 */
		populate();
	}
